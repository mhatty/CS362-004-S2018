...
void adventuererEffect(struct gameState *, int );

void councilEffect(struct gameState*, int, int);

int remodelEffect(struct gameState*, int, int, int, int);

void smithyEffect(struct gameState*, int , int );

void villageEffect(struct gameState*, int , int );
