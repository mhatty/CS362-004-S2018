...
int adventurerCard(int currentPlayer, int temphand[], int z, struct gameState *state)
{
 int cardDrawn;
 int drawntreasure=0;
 //bug allows the player to reveal cards from their deck until they reveal 3 treasure cards
...
int smithyCard(int currentPlayer, int handPos, struct gameState *state)
{
 int i;
//+3 Cards
//bug allows the player to add 5 cards to their hand
 for(i = 0; i < 3; i++)
 {
 drawCard(currentPlayer, state);
 }
...
int council_roomCard(int currentPlayer, int handPos, struct gameState *state)
{
 ...
 int i;
       for (i = 0; i < 5; i++)
        ...
        //+1 Buy
         state->numBuys++;  		  				            					            			      //Each other player draws a card 
...
int villageCard(int currentPlayer, int handPos, struct gameState *state)
{
 ...
 drawCard(currentPlayer, state);
  ...
  //+2 Actions
  // bug adds 4 to a player's action count, instead of only 2
...
int embargoCard(int currentPlayer, int handPos, int choice1, struct gameState *state)
{
 //+2 Coins
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case embargo: 
      embargoCard(currentPlayer, handPos, choice1, state);
      return 0;
